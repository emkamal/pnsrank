...
function getPNSData($idPNS)
{
    ...
    $sql = "SELECT t1.name as NamaPNS, t2.nama as NamaKantor, t3.namaArea as NamaArea, t3.idArea as idArea from PNS t1, kantorPP t2, area t3 WHERE idPNS = $idPNS AND t1.idKantor = t2.idKantor AND t2.idArea = t3.idArea";
    $result = mysqli_query($conn, $sql);
