...
<html lang="en">
<head>
    <title>MataLayan Dashboard</title>
    <meta charset="utf-8">
    ...
    <div>
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="index.php" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">PNS Dashboard</span><span style="display: none" class="logo-text-icon">�</span></a></div>
