<ul id="side-menu" class="nav">
                    ...
                    </i><span class="menu-title">Input Data</span></a>
                       
                    </li>
                    <li><a href="data.php"><i class="fa fa-th-list fa-fw">
                        <div class="icon-bg bg-green"></div>
                    </i><span class="menu-title">Data Pelayanan</span></a>
                       
                    </li>
                    <li><a href="feedback.php"><i class="fa fa-edit fa-fw">
